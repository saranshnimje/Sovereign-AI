...
SAMPLE_APPROVAL_REQUESTS = [
    ...
    },
    {
        ...
        "operation_detail_json": json.dumps({
            "tool_name": "production_planner",
            "input": {"line": 2, "action": "swap_orders", "order_a": "PO-4521", "order_b": "PO-4538"},
        }),
        "risk_level": "high",
        "status": "pending",
        "expires_hours": 2,
    },
    {
        ...
        "operation_detail_json": json.dumps({
            "tool_name": "python_exec",
            "input": {"script": "predictive_maintenance.py", "params": {"asset": "C-12", "model": "xgboost_v2"}},
        }),
        "risk_level": "low",
        "status": "approved",
        "decided_hours_ago": 3,
        "decision_note": "Approved. Predictive models are read-only and safe to run.",
        "expires_hours": 24,
    },
    {
        ...
        "operation_detail_json": json.dumps({
            ...
            "input": {"destination": "vendor_portal", "dataset": "qc_inspections_aug2025", "format": "csv"},
        }),
        "risk_level": "critical",
        "status": "rejected",
        "decided_hours_ago": 4,
        "decision_note": "Rejected: Data export to external systems requires management approval and data classification review.",
        "expires_hours": 24,
    },
    {
        ...
        "operation_detail_json": json.dumps({
            ...
            "input": {"module": "procurement", "setting": "vendor_scoring_weights", "values": {"quality": 0.4, "delivery": 0.3, "price": 0.2, "sustainability": 0.1}},
        }),
        "risk_level": "medium",
        "status": "pending",
        "expires_hours": 6,
    ...
    {
        "operation": "Execute Python script in sandbox: batch_data清洗.py",
        "operation_detail_json": json.dumps({
            "tool_name": "python_exec",
            "input": {"script": "batch_data_clean.py", "params": {"source": "sensor_readings", "dedup": True, "fillna": "interpolate"}},
        }),
        "risk_level": "medium",
        "status": "approved",
        "decided_hours_ago": 2,
        "decision_note": "Approved. Data cleaning script is non-destructive, creates backup before modifying.",
        "expires_hours": 24,
    },
    {
        ...
        "operation_detail_json": json.dumps({
            "tool_name": "notification_send",
            "input": {"channel": "email", "recipient": "procurement@company.com", "template": "expired_contracts_alert", "count": 3},
        }),
        "risk_level": "low",
        "status": "pending",
        "expires_hours": 12,
    },
    {
        ...
        "operation_detail_json": json.dumps({
            "tool_name": "kb_delete_document",
            "input": {"target": "audit_logs", "filter": {"older_than": "2023-08-01"}, "dry_run": False},
        }),
        "risk_level": "critical",
        "status": "pending",
        "expires_hours": 1,
    },
    {
        ...
        "operation_detail_json": json.dumps({
            "tool_name": "config_update",
            "input": {"module": "agent_permissions", "role": "analyst", "add_tool": "web_search"},
        }),
        "risk_level": "high",
        "status": "approved",
        "decided_hours_ago": 5,
        "decision_note": "Approved. Web search is read-only and analysts need it for research tasks.",
        "expires_hours": 24,
    },
    {
        ...
        "operation_detail_json": json.dumps({
            "tool_name": "python_exec",
            "input": {"script": "fft_analysis.py", "params": {"memory_limit": "2GB", "time_range": "30d"}},
        }),
        "risk_level": "medium",
        "status": "rejected",
        "decided_hours_ago": 1,
        "decision_note": "Rejected: Memory limit exceeds sandbox cap (512MB). Use chunked processing instead.",
        "expires_hours": 24,
    },
    {
        ...
        "operation_detail_json": json.dumps({
            "tool_name": "kb_create",
            "input": {"name": "Compressor Maintenance Archive", "source": "uploaded_files", "file_count": 12, "embedding_model": "nomic-embed-text"},
        }),
        "risk_level": "low",
        "status": "approved",
        "decided_hours_ago": 6,
        "decision_note": "Approved. New KB creation is a standard operation.",
        "expires_hours": 24,
    },
    {
        "operation": "Execute Python script in sandbox: network_scan.py",
        "operation_detail_json": json.dumps({
            "tool_name": "python_exec",
            "input": {"script": "network_scan.py", "params": {"target": "192.168.1.0/24", "ports": "common"}},
        }),
        "risk_level": "critical",
        "status": "rejected",
        "decided_hours_ago": 7,
        "decision_note": "Rejected: Network scanning is a restricted operation. Must be performed by IT security team directly.",
        "expires_hours": 24,
    },
    {
        ...
        "operation_detail_json": json.dumps({
            "tool_name": "config_update",
            "input": {"module": "llm_providers", "provider": "ollama", "model": "qwen3:14b", "setting": "num_ctx", "value": 8192},
        }),
        "risk_level": "medium",
        "status": "pending",
        "expires_hours": 4,
    },
    {
        ...
        "operation_detail_json": json.dumps({
            "tool_name": "data_maintenance",
            "input": {"target": "agent_runs", "filter": {"status": "completed", "older_than_days": 90}, "action": "archive"},
        }),
        "risk_level": "high",
        "status": "pending",
        "expires_hours": 3,
    },
    {
        ...
        "operation_detail_json": json.dumps({
            "tool_name": "data_import",
            "input": {"source": "calibration_aug2025.csv", "target": "sensor_calibrations", "rows": 450, "overwrite": False},
        }),
        "risk_level": "low",
        "status": "approved",
        "decided_hours_ago": 8,
        "decision_note": "Approved. Import is append-only and does not overwrite existing records.",
        "expires_hours": 24,
    },
    {
        "operation": "Execute Python script in sandbox: sql_query.py against production DB",
        "operation_detail_json": json.dumps({
            "tool_name": "python_exec",
            "input": {"script": "sql_query.py", "params": {"connection": "production", "query": "SELECT * FROM orders WHERE status='pending'"}},
        }),
        "risk_level": "critical",
        "status": "pending",
        "expires_hours": 1,
...
async def seed():
    async with AsyncSessionLocal() as session:
        ...
        paired_runs = [agent_run_ids[i % len(agent_run_ids)] for i in range(22)]
